...
information:CreateLabel("Script by Orangina")
...
guiElements["toggles"]["fastcrosshairs"] = farmo:CreateToggle("Smart Precise Crosshairs", nil, function(State) kocmoc.toggles.fastcrosshairs = State end)
...
guiElements["toggles"]["autoplantsprout"] = farmt:CreateToggle("Auto Plant Magic Bean", nil, function(State) kocmoc.toggles.autoplantsprouts = State end)
